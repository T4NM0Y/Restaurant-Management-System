...
public class CustomerSignUp extends JFrame implements ActionListener{
    ...
    private JLabel label1,userName,userPass,email,confirmUserPass;
    private JTextField tfUName,tfemail;
    ...
    public CustomerSignUp()
    {
        ...
        frame = new JFrame("CustomerSignUp");
        frame.setBounds(0,0,820,580);
